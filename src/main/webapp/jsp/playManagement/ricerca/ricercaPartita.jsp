	...
	<main role="main" class="container">
		...
		<div class='card'>
		    ...
		    <div class='card-body'>
			  ...
			  <form method="post" 
				action="${pageContext.request.contextPath}/accessoEffettuato/playManagement/ricerca/ExecuteRicercaPartitaServlet" novalidate="novalidate">
				...
				<div class="form-row">
				  <div class="form-group col-md-6">
				    <label>Username del creatore</label>
				    <input type="text" name="usernameCreatore" id="usernameCreatore" class="form-control">
				  </div>	
				  <div class="form-group col-md-6">
				    <label>Username di un utente che sta attualmente giocando in quella partita</label>
				    <input type="text" name="usernameGiocatore" id="usernameGiocatori" class="form-control">
				  </div>			 
				</div>
