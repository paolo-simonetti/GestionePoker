...
<body>
	...
	<jsp:useBean id="criteriRicercaTavoli" class="it.solvingteam.GestionePokerSpringDataMavenDTOAjax.beans.TavoloDTOBean" scope="request" />
	<jsp:setProperty name="criteriDiRicerca" property="criteriDiRicerca" value="${requestScope.criteriDiRicerca}"/>
		                ...
		                <tbody>
		                	  ...
		                	  <tr >
		                        ...
		                        <td><c:out value="${item.puntataMinima}"></c:out></td>
								  ...
								  <c:if test="${item.giocatori.size()>0}">
