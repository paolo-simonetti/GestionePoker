...
public class UtenteServiceImpl implements UtenteService {
	...
	public Set<Utente> findByExample(Utente example) {
		 ...
		 * sui parametri dell'utente (cioè, niente tavoli né ruoli). Nella pagina di risultati, avrò
		 * una lista di utenti, e su "Dettaglio Utente" vedrò anche Ruolo e Tavolo */
